...
export const Route = createFileRoute("/_admin/styles/new")({
  component: StylesNewPage,
});

function StylesNewPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl">Tambah Gaya Baru</h2>
          <p className="text-sm text-muted-foreground font-mono">
            Isi detail gaya visual untuk ditambahkan ke pustaka
          </p>
        </div>
      </div>
